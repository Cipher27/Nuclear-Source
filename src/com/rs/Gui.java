...
public class Gui extends JFrame {
	 ...
	 */
	public Gui() {
		setTitle("hellions's Server Panel");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 611, 361);
		contentPane = new JPanel();
		contentPane.setBorder(new MatteBorder(2, 2, 2, 2, new Color(0, 0, 0)));
 ...
 public void Uptime(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_banButtonActionPerformed
	{
	...
	public static String Uptime() {//GEN-FIRST:event_banButtonActionPerformed
	{
		RuntimeMXBean bean = ManagementFactory.getRuntimeMXBean();
		long second = bean.getUptime() / 1000;
		long hours = second /3600;
		long minute = hours % 60; 
		return "Server uptime: "+Colors.white +hours+"h:"+ minute + "m";
		}
	} 
