...
public final class ZarosGodwars {
	...
	public static void endWar() {
	  ...
	  private static final Animation START = new Animation(6355),
			    SECOND_START = new Animation(6987),
				...
				WorldTasksManager.schedule(new WorldTask() {
					...
					public void run() {
						...
						if (count == 1) {
							...
							//World.spawnNPC(13452, new WorldTile(2936, 5214, 0),
							//		-1, true, true);
							World.spawnNPC(13452, new WorldTile(2937, 5215, 0),
									-1, true, true, false);
							umbra.setNextGraphics(new Graphics(3361));
							...
							World.spawnNPC(13453, new WorldTile(2937, 5191, 0),
									-1, true, true, false);
							cruor.setNextGraphics(new Graphics(3358));
							...
							World.spawnNPC(13454, new WorldTile(2913, 5191, 0),
									-1, true, true, false);
							glacies.setNextGraphics(new Graphics(3360));
							...
							nex.setNextAnimation(new Animation(6987));//ice
