...
public class WarriorsGuild extends Controler {
	...
	//player.setNextAnimation(new Animation(PlayerCombat.(player.getEquipment().getWeaponId(), player.getCombatDefinitions().getAttackStyle())));
	WorldTasksManager.schedule(new WorldTask() {
	...
	for (int index = 0; index < DEFENDERS.length; index++) {
		...
		player.sm("You have received a defender drop, check the ground.");
