...
public class Class289 {
	...
	/*public boolean method2739(int i, int i_29_, int i_30_, int i_31_,
			int i_32_, int i_33_, int i_34_, int i_35_, int i_36_) {
		try {
			if (i_30_ > 1) {
				if (Class287.method2720(i, i_29_, i_30_, i_30_, i_31_, i_32_,
						i_33_, i_34_, -173263894))
					return true;
				return method2740(i, i_29_, i_30_, i_30_, i_31_, i_32_, i_33_,
						i_34_, i_35_, (byte) -47);
			}
			...
			if (i == i_31_ - 1
					&& i_29_ >= i_32_
					&& i_29_ <= i_38_
					&& 0 == ((anIntArrayArray3155[i - 1487776559 * anInt3151][i_29_
							- 1415525851 * anInt3152]) & 0x8)
					&& (i_35_ & 0x8) == 0)
				return true;
			if (1 + i_37_ == i
					&& i_29_ >= i_32_
					&& i_29_ <= i_38_
					&& ((anIntArrayArray3155[i - anInt3151 * 1487776559][i_29_
							- anInt3152 * 1415525851]) & 0x80) == 0
					&& (i_35_ & 0x2) == 0)
				return true;
			if (i_32_ - 1 == i_29_
					&& i >= i_31_
					&& i <= i_37_
					&& ((anIntArrayArray3155[i - anInt3151 * 1487776559][i_29_
							- 1415525851 * anInt3152]) & 0x2) == 0
					&& 0 == (i_35_ & 0x4))
				return true;
			if (i_29_ == i_38_ + 1
					&& i >= i_31_
					&& i <= i_37_
					&& 0 == ((anIntArrayArray3155[i - anInt3151 * 1487776559][i_29_
							- 1415525851 * anInt3152]) & 0x20)
					&& (i_35_ & 0x1) == 0)
				return true;
			return false;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lz.z(").append(')').toString());
		}
	}*/
	...
	/*static final void method2745(Class403 class403, int i) {
		try {
			((Class403) class403).anInt5245 -= -1365138610;
			if ((((Class403) class403).aLongArray5251[1685767703 * ((Class403) class403).anInt5245]) < (((Class403) class403).aLongArray5251[1685767703 * ((Class403) class403).anInt5245 + 1]))
				((Class403) class403).anInt5259 += ((((Class403) class403).anIntArray5257[1883543357 * ((Class403) class403).anInt5259]) * 286750741);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lz.bo(").append(')').toString());
		}
	}
	...
	static final void method2746(Class403 class403, int i) {
		try {
			...
			int i_84_ = (((Class403) class403).anIntArray5244[681479919 * ((Class403) class403).anInt5239]);
			int i_85_ = (((Class403) class403).anIntArray5244[1 + ((Class403) class403).anInt5239 * 681479919]);
			ClientScriptMap class483 = Class51.aClass475_506.getClientScriptMap(i_84_,
					1528209569);
			if ('s' == class483.aChar6037) {
				
			}
			((Class403) class403).anObjectArray5240[((((Class403) class403).anInt5241 += 969361751)
					* -203050393 - 1)] = class483.method6122(i_85_, (byte) -30);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lz.vy(").append(')').toString());
		}
	}*/
}
