...
public final class Class285 {
	...
	/*public static String method2709(int i, int i_0_) {
		try {
			return new StringBuilder().append("<col=").append(
					Integer.toHexString(i)).append(">").toString();
	...
	static final void method2712(int i, int i_2_, int i_3_, int i_4_, int i_5_,
			int i_6_, int i_7_) {
		try {
			if (i - i_3_ >= Class372_Sub1.anInt4051 * -1424479739
					&& i + i_3_ <= Class372_Sub1.anInt4048 * 1135094847
					&& i_2_ - i_3_ >= Class372_Sub1.anInt4049 * 1155384281
					&& i_3_ + i_2_ <= -1062447355 * Class372_Sub1.anInt4050)
				Class487
						.method6165(i, i_2_, i_3_, i_4_, i_5_, i_6_, 1691112571);
			else
				Class315.method3836(i, i_2_, i_3_, i_4_, i_5_, i_6_, (byte) 55);
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("lv.u(").append(')').toString());
		}
	}
		...
		try {
			if (!Class436.aBoolean5478) {
				...
				if (!((Class298_Sub37_Sub15) class298_sub37_sub15).aBoolean9668) {
					...
					if (null != class298_sub37_sub5
							&& class298_sub37_sub5.method3418(
									class298_sub37_sub15, -948596623))
						Class75.method837(class298_sub37_sub5, -2092429244);
				} else {
					for (Class298_Sub37_Sub5 class298_sub37_sub5 = ((Class298_Sub37_Sub5) Class436.aClass461_5482
							.method5984(-1184499761)); class298_sub37_sub5 != null; class298_sub37_sub5 = ((Class298_Sub37_Sub5) Class436.aClass461_5482
							.method5985(79001809))) {
						if (((Class298_Sub37_Sub5) class298_sub37_sub5).aString9585
								.equals(((Class298_Sub37_Sub15) class298_sub37_sub15).aString9657)) {
							boolean bool = false;
							for (Class298_Sub37_Sub15 class298_sub37_sub15_12_ = ((Class298_Sub37_Sub15) ((Class298_Sub37_Sub5) class298_sub37_sub5).aClass461_9584
									.method5984(-611796752)); class298_sub37_sub15_12_ != null; class298_sub37_sub15_12_ = ((Class298_Sub37_Sub15) ((Class298_Sub37_Sub5) class298_sub37_sub5).aClass461_9584
									.method5985(241315594))) {
								if (class298_sub37_sub15_12_ == class298_sub37_sub15) {
									if (class298_sub37_sub5.method3418(
											class298_sub37_sub15, -948596623))
										Class75.method837(class298_sub37_sub5,
												-1144026748);
									bool = true;
									break;
								}
