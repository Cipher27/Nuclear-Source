...
public class ExactStrategy extends PathStrategy {
	...
	/*public static GameObjectType[] method4108(int i) {
		try {
			return (new GameObjectType[] { GameObjectType.T0,
					GameObjectType.T17, GameObjectType.T14,
					GameObjectType.T5, GameObjectType.T2,
					GameObjectType.T6, GameObjectType.T3,
					GameObjectType.T11, GameObjectType.T16,
					GameObjectType.T12, GameObjectType.T20,
					GameObjectType.T21, GameObjectType.T15,
					GameObjectType.T19, GameObjectType.T18,
					GameObjectType.T22, GameObjectType.T9,
					GameObjectType.T8, GameObjectType.T4,
					GameObjectType.T1, GameObjectType.T7,
					GameObjectType.T10, GameObjectType.T13 });
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder()
					.append("acy.a(").append(')').toString());
		}
