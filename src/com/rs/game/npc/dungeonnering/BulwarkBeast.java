...
public final class BulwarkBeast extends DungeonBoss {
	...
	if (weaponId != -1 && MiningBase.getPickAxeDefinitions(playerSource,
		true) != null/*
			      * (weaponId >= 16295 && weaponId <= 16315) ||
			      * (weaponId >= 16142 && weaponId <= 16152)
			      */) {
	    hit.setDamage(Utils.random(50));
	    hit.setLook(HitLook.ABSORB_DAMAGE);
	    shieldHP -= hit.getDamage();
	    playerSource.getPackets()
		    .sendGameMessage(shieldHP > 0 ? "Your pickaxe chips away at the beast's armour plates."
