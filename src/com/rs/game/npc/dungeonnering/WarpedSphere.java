...
public class WarpedSphere extends DungeonNPC {
    ...
    private static final int[][] ORB_TELEPORT_LOCATIONS = { { 0, 0 }, { 0, 0 }, { 13, 4 }, { 11, 12 }, { 3, 4 },
	    { 3, 12 } },
	...
	if (stage > 0) {
		...
		for (Player player : getManager().getParty().getTeam()) {
			...
			Magic.sendTeleportSpell(player, 13493, 13494, 2437, 2435, 0, 0,
				getManager().getTile(reference, TELEPORT_TILE[0], TELEPORT_TILE[1]), 6, false, 0);
		    }
		}
	    }
	}
