...
public final class SkeletalAdventurer extends DungeonBoss {
    ...
    public SkeletalAdventurer(int id, WorldTile tile, DungeonManager manager, RoomReference reference,
	    double multiplier) {
	...
	for (Player p2 : players) {
	    ...
	    p2.getPackets().sendGameMessage(
		    "" + luckyPlayer.getDisplayName() + " received: " + item.getAmount() + " " + item.getName() + ".");
	}*/
    }
