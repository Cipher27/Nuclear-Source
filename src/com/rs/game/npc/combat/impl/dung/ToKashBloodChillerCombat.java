...
public class ToKashBloodChillerCombat extends CombatScript {
	...
	if (perfectDamage) {
	    ...
	    target.applyHit(
		    new Hit(npc, (int) Utils.random(boss.getMaxHit() * .90, boss.getMaxHit()), HitLook.MAGIC_DAMAGE));
	}
    ...
    public static void setSpecialFreeze(final Player player, final ToKashBloodChiller boss,
