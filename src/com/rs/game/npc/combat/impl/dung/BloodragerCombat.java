...
public class BloodragerCombat extends CombatScript {
	...
	if (usingSpecial) {
	    ...
	    damage = getRandomMaxHit(npc, (int) (npc.getMaxHit(NPCCombatDefinitions.MELEE) * (1.05 * tier)),
		    NPCCombatDefinitions.MELEE, target);
	} else
	    damage = getRandomMaxHit(npc, npc.getMaxHit(), NPCCombatDefinitions.MELEE, target);
