...
public class WarpedGulegaCombat extends CombatScript {
	...
	case 3:// reg aeo melee
		...
		public void run() {
			...
			tileLoop: for (WorldTile tile : attackTiles) {
				...
				delayHit(npc, 0, t,
					getMeleeHit(npc,
						getRandomMaxHit(npc, (int) (npc.getMaxHit(NPCCombatDefinitions.MELEE) * 0.75),
	...
	case 1:// reg range aeo
		...
		delayHit(npc, 2, t, getRangeHit(npc, getRandomMaxHit(npc,
			(int) (npc.getMaxHit(NPCCombatDefinitions.MELEE) * 0.75), NPCCombatDefinitions.RANGE, t)));
	    }
	    break;
	case 2:// reg magic aeo
		...
		delayHit(npc, 2, t, getMagicHit(npc, getRandomMaxHit(npc,
			(int) (npc.getMaxHit(NPCCombatDefinitions.MELEE) * 0.75), NPCCombatDefinitions.MAGE, t)));
	    }
	    break;
	case 0:
	    npc.setNextAnimation(new Animation(15004));
