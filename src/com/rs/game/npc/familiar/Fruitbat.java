...
public class Fruitbat extends Familiar {
    ...
    private static final transient int[] FRUITS = new int[]{5972, 5974, 2102,
            2120, 1963, 2108, 5982};
    ...
    private void addFruitReward() {
        getBob().getBeastItems().add(
                new Item(FRUITS[Utils.random(FRUITS.length)], 1));
        fruitTicks = 0;
    }
    ...
    public boolean submitSpecial(Object object) {
        ...
        for (int trycount = 0; trycount < Utils.getRandom(8); trycount++) {
            ...
            World.addGroundItem(
                    new Item(FRUITS[Utils.random(FRUITS.length)], 1), tile,
                    player, true, 120, isFinished());
        }
        return false;
    }
}
