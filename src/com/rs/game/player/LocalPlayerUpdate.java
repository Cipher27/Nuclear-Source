...
//	private byte[] slotFlags;
	...
	//	slotFlags = new byte[2048];
		...
		localPlayersIndexes = new int[Settings.LOCAL_PLAYERS_LIMIT];
		outPlayersIndexes = new int[2048];
		regionHashes = new int[2048];
		cachedAppearencesHashes = new byte[Settings.LOCAL_PLAYERS_LIMIT][];
	}
