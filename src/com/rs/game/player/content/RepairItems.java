...
import com.rs.game.player.achievements.impl.RepairAchievement;
...
//Main structure NAME(Broken itemId, repaired itemId,Price to repair it)
	...
	if(brokenitems.getId() >= 20138 && brokenitems.getId() <= 20170)
		player.getAchievementManager().notifyUpdate(RepairAchievement.class);
