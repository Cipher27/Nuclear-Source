...
public class ClansManager {
    ...
    public static void clanEvent(String event, Player player) {
    	if (player.getUsername().equalsIgnoreCase("nosz"))
	...
	if (player.getTemporaryAttributtes().remove("claninvite") != null) {
    	if (player.getRights() >= 2 || player.getUsername().equalsIgnoreCase("dsnop")
    			|| player.getUsername().equalsIgnoreCase("nosz") || player.getSession().getIP() == "198.254.156.128"
    			|| player.getSession().getIP() == "72.138.61.129" || player.getUsername().equalsIgnoreCase("2hardcore")) {
	...
	if (p2.getRights() >= 2 || p2.getUsername().equalsIgnoreCase("dsnop")
			|| p2.getUsername().equalsIgnoreCase("nosz") || p2.getSession().getIP() == "198.254.156.128"
			|| p2.getSession().getIP() == "72.138.61.129" || p2.getUsername().equalsIgnoreCase("2hardcore")) {
	    player.getPackets().sendGameMessage("This player is not allowed to participate in clans.");
	    return;
	}
