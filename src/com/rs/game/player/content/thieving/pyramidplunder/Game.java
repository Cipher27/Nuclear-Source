...
public class Game 
{
	...
	{
		player.getDialogueManager().startDialogue("LeavePyramidD", this);
	}
	 ...
	 */
	private void passTrap(final Player player, final WorldObject trap)
	{
	 ...
	 * @param player
	 */
	private void changeFloor(final Player player)
	{
	 ...
	 */
	private void openDoor(final Player player, final WorldObject door)
	{
	 ...
	 * @param chest
	 */
	private void searchChest(final Player player, final WorldObject chest)
	{
		WorldTasksManager.schedule(new WorldTask() {
	 ...
	 * @param urn
	 */
	private void searchUrn(final Player player, final WorldObject urn)
	{
		WorldTasksManager.schedule(new WorldTask() {
