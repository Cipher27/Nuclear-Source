...
public class ItemSets {
    ...
    //screw you sonic LOL. It takes a second to find IDs. - Adam
	// ok - paolo
	...
	BLUEMYSTICROBES(11868, 4089, 4091, 4093, 4095, 4097),
	LIGHTMYSTICROBES(11960, 4109, 4113, 4113, 4115, 4117),
	...
	player.getPackets().sendGameMessage("You open the spirit shard pack and receive " + totalAmount + " "+ItemDefinitions.getItemDefinitions(openedItem).getName().toLowerCase()+".");
    }
}
