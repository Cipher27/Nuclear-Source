...
public class WildyLavaShark {
	...
	public static void startEvent() {
	    ...
	    ActivityHandler.setWildySkillingEvent("<col= 0099cc>Lava Shark: </col>" +spawns.getHint()+"");
		World.spawnNPC(14907, new WorldTile(spawns.getTile().getX(), spawns.getTile().getY(), 0), -1, true, true,false);
        World.sendWorldMessage("<img=7><col=ff0000>[Wildy event] </col>Lava shark spot has been spotted by Darius, be quick before someonelse mines them. ", true);
