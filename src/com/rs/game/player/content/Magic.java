...
public class Magic {
	...
	@SuppressWarnings("unused")
	static final int ASTRAL_RUNE = 9075;
	...
	public static final boolean hasInfiniteRunes(int runeId, int weaponId,
		...
		if (runeId == AIR_RUNE) {
			...
			if (weaponId == 1383 || shieldId == 18346 || shieldId == 18346) // water staff
				return true;
		} else if (runeId == EARTH_RUNE) {
			if (weaponId == 1385) // earth staff
				return true;
		} else if (runeId == FIRE_RUNE) {
			if (weaponId == 1387 || weaponId == 22494 || weaponId == 19323) // fire staff
				return true;
		} else if (runeId == MIND_RUNE) {
			if (weaponId == 69) // Polypore
				return true;
		} else if (runeId == NATURE_RUNE) {
			if (weaponId == 69 || weaponId == 18341) // Polypore
				return true;
			...
			if (weaponId == 69 || weaponId == 18342) // Polypore
				return true;
	...
	public static final void processLunarSpell(Player player, int spellId,
		...
		case 43://Lunar island
			sendLunarTeleportSpell(player, 69, 64, new WorldTile(2100, 3914,
					0), LAW_RUNE, 1, ASTRAL_RUNE, 2, EARTH_RUNE, 2);
			break;
			
		case 54://ZMI alter
			sendLunarTeleportSpell(player, 71, 64, new WorldTile(2455, 3233,
					0), LAW_RUNE, 1, ASTRAL_RUNE, 2, EARTH_RUNE, 6);
			break;
			
		case 67://South Falador
			sendLunarTeleportSpell(player, 72, 64, new WorldTile(3007, 3327,
					0), LAW_RUNE, 1, ASTRAL_RUNE, 2, AIR_RUNE, 2);
			break;
			
		case 47://WaterBirth Island
			sendLunarTeleportSpell(player, 72, 64, new WorldTile(2547, 3754,
					0), LAW_RUNE, 1, ASTRAL_RUNE, 2, WATER_RUNE, 1);
			break;
			
		case 22://Barbarian Outpost
			sendLunarTeleportSpell(player, 75, 64, new WorldTile(2544, 3569,
					0), LAW_RUNE, 2, ASTRAL_RUNE, 2, FIRE_RUNE, 2);
			break;
			
		case 69://North Ardougne
			sendLunarTeleportSpell(player, 76, 64, new WorldTile(2614, 3340,
					0), LAW_RUNE, 1, ASTRAL_RUNE, 2, WATER_RUNE, 5);
			break;
			
		case 41://Port Khazard
			sendLunarTeleportSpell(player, 78, 64, new WorldTile(2660, 3157,
					0), LAW_RUNE, 2, ASTRAL_RUNE, 2, WATER_RUNE, 4);
			break;
			
		case 40://Fishing Guild
			sendLunarTeleportSpell(player, 85, 64, new WorldTile(2614, 3385,
					0), LAW_RUNE, 3, ASTRAL_RUNE, 3, WATER_RUNE, 8);
			break;
			
		case 44://Catherby
			sendLunarTeleportSpell(player, 87, 64, new WorldTile(2808, 3434,
					0), LAW_RUNE, 3, ASTRAL_RUNE, 3, WATER_RUNE, 10);
			break;
			
		case 51://Ice Plat
			sendLunarTeleportSpell(player, 89, 64, new WorldTile(2971, 3915,
					0), LAW_RUNE, 3, ASTRAL_RUNE, 3, WATER_RUNE, 8);
			break;
			
		case 75://TrollHeim
			sendLunarTeleportSpell(player, 92, 64, new WorldTile(2889, 3669,
					0), LAW_RUNE, 3, ASTRAL_RUNE, 3, WATER_RUNE, 10);
	...
	public static final int DUNG_COSMIC_RUNE = 17789;
    ...
    public static final boolean sendNormalTeleportSpell2(Player player, int level, double xp, WorldTile tile, int... runes) {
