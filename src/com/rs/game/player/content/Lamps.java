...
public class Lamps {
    ...
    public static final int[] SELECTABLE_XP_LAMPS = new int[] { 23713, 23714, 23715, 23716, 18782,33723,30550 };
    public static final int[] SELECTABLE_XP_LAMPS_TYPES = new int[] { LAMP_SMALL, LAMP_MEDIUM, LAMP_BIG, LAMP_HUGE, LAMP_BIG, LAMP_BIG,LAMP_SMALL };
	...
	player.getDialogueManager().startDialogue(new Dialogue() {
		...
		if(player.isSkiller() && Skills.isCombatSkill(selectedSkill)){
			player.sm("You can't use your lamps on combat skills as a skiller");
			return;
		}
