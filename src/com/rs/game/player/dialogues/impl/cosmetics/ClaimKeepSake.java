...
public class ClaimKeepSake extends Dialogue {
	...
	private String[] getDialogueOptions() {
		...
		dialogueOptions.add(currentPage == 0 ? (Utils.formatPlayerNameForDisplay(new Item(pages[currentPage][0]).getName())) : "Back");
	...
	private void sendConfirmation() {
		stage = 0;
		sendOptionsDialogue(DEFAULT_OPTIONS_TITLE, "Re-Claim item.", "Back.", "Cancel.");
	}
