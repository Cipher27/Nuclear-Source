...
import com.rs.game.player.content.ports.actions.TetsuSmithing;
import com.rs.game.player.dialogues.Dialogue;

public class TetsuSmithingD extends Dialogue {
private int itemId;
	...
	public void start() {
		SkillsDialogue.sendSkillsDialogue(player, SkillsDialogue.MAKE,
				...
				new int[] { 26325,26326,26327 }, new SkillsDialogue.ItemNameFilter() {
					@Override
	...
	public void run(int interfaceId, int componentId) {
		...
		player.getActionManager().setAction(new Action() {
			...
			public int processWithDelay(Player player) {
				ticks--;
				TetsuSmithing.canSmith(player, itemId);
				return 2;
			}
