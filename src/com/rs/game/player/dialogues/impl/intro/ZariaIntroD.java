package com.rs.game.player.dialogues.impl.intro;
...
public class ZariaIntroD extends Dialogue {
			...
			if (componentId == OPTION_5) {
				...
				sendOptionsDialogue("Picking Your Starter Class!",
					...
					sendOptionsDialogue("Picking Your Game Mode!",
						...
						player.unlock();
						player.getPackets().sendGameMessage("You may now enter the realm of Hellion through this portal");
