...
public class SolomonD extends Dialogue {
	...
	public void run(int interfaceId, int componentId) {
		...
		case 5:
			switch (componentId) {
			case OPTION_1:
				if ( !player.getOverrides().paladin) {
				...
				break;
			case OPTION_2:
				if ( !player.getOverrides().warlord) {
					sendNPCDialogue(npcId, SAD,
							"I'm sorry, but you will have to purchase this item " + "in order to unlock it.");
					stage = 4;
					return;
				...
				break;
			case OPTION_3:
				if ( !player.getOverrides().obsidian) {
					sendNPCDialogue(npcId, SAD,
							"I'm sorry, but you will have to purchase this item " + "in order to unlock it.");
					stage = 4;
					return;
				...
				break;
			case OPTION_4:
				if ( !player.getOverrides().kalphite) {
					sendNPCDialogue(npcId, SAD,
							"I'm sorry, but you will have to purchase this item " + "in order to unlock it.");
					stage = 4;
					return;
		...
		case 6:
			switch (componentId) {
			case OPTION_1:
				if ( !player.getOverrides().demonflesh) {
					sendNPCDialogue(npcId, SAD,
							"I'm sorry, but you will have to purchase this item " + "in order to unlock it.");
					stage = 4;
					return;
				...
				break;
			case OPTION_2:
				if ( !player.getOverrides().remokee) {
					sendNPCDialogue(npcId, SAD,
							"I'm sorry, but you will have to purchase this item " + "in order to unlock it.");
					stage = 4;
					return;
				...
				break;
			case OPTION_3:
				if ( !player.getOverrides().assassin) {
					sendNPCDialogue(npcId, SAD,
							"I'm sorry, but you will have to purchase this item " + "in order to unlock it.");
					stage = 4;
					return;
				...
				break;
			case OPTION_4:
				if ( !player.getOverrides().skeleton) {
					sendNPCDialogue(npcId, SAD,
							"I'm sorry, but you will have to purchase this item " + "in order to unlock it.");
					stage = 4;
					return;
		...
		case 7:
			...
			case OPTION_2:
				...
				break;
			case OPTION_3:
				if ( !player.getOverrides().replicaDragon) {
					sendNPCDialogue(npcId, SAD,
							"I'm sorry, but you will have to purchase this item " + "in order to unlock it.");
					stage = 4;
					return;
				...
				break;
			case OPTION_4:
				if ( !player.getOverrides().sentinel) {
					sendNPCDialogue(npcId, SAD,
							"I'm sorry, but you will have to purchase this item " + "in order to unlock it.");
					stage = 4;
					return;
		...
		case 8:
			...
			case OPTION_2:
				...
				break;
			case OPTION_3:
				if ( !player.getOverrides().skyguard) {
					sendNPCDialogue(npcId, SAD,
							"I'm sorry, but you will have to purchase this item " + "in order to unlock it.");
					stage = 4;
					return;
				...
				break;
			case OPTION_4:
				if ( !player.getOverrides().vyrewatch) {
					sendNPCDialogue(npcId, SAD,
							"I'm sorry, but you will have to purchase this item " + "in order to unlock it.");
					stage = 4;
					return;
		...
		case 9:
			switch (componentId) {
			case OPTION_1:
				if ( !player.getOverrides().snowman) {
					sendNPCDialogue(npcId, SAD,
							"I'm sorry, but you will have to purchase this item " + "in order to unlock it.");
					stage = 4;
					return;
				...
				break;
			case OPTION_2:
				if ( !player.getOverrides().samurai) {
					sendNPCDialogue(npcId, SAD,
							"I'm sorry, but you will have to purchase this item " + "in order to unlock it.");
					stage = 4;
					return;
				...
				break;
			case OPTION_3:
				if ( !player.getOverrides().warmWinter) {
					sendNPCDialogue(npcId, SAD,
							"I'm sorry, but you will have to purchase this item " + "in order to unlock it.");
					stage = 4;
					return;
				...
				break;
			case OPTION_4:
				/*if ( !player.getOverrides().darkLord) {
					sendNPCDialogue(npcId, SAD,
							"I'm sorry, but you will have to purchase this item " + "in order to unlock it.");
					stage = 4;
					return;
