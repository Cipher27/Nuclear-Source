...
public class GrimGem extends Dialogue {
	...
	@Override
	public void start() {
			sendNPCDialogue(14386, 9827, "What can I do for you?");
	}
		...
		case 2:
			if (componentId == OPTION_1) {
				if (player.getContract() == null) {
					...
					sendNPCDialogue( 14386,
				    9827, "You already have a task, would you like to reset it?",
			...
			if (componentId == OPTION_2) {
				sendNPCDialogue( 14386, 9827, "Of course..");
				stage = 4;
				break;
			...
			if (componentId == OPTION_3) {
				if (player.getTotalContract() >= 500 || player.getTotalKills() >= 5000) {
					...
					sendNPCDialogue(14386,
					    9827, "You are not worthy of my titles.",
			...
			if (player.getContract() == null) {
				...
				if (player.hasMoney(5000000)){
					...
					sendNPCDialogue( 14386,
							...
							"You need at least 5'000'000 coins in order to reset your assignment."
);
					stage = 1;
					break;
				}
	...
	case 7:
		if (componentId == OPTION_1) {
			if (player.getTotalContract() >= 500) {
				...
				sendNPCDialogue(14386, 9827, "You need to complete 500 contracts to use this title.");
				stage = 1;
				break;
			}
		}
		if (componentId == OPTION_2) {
			if (player.getTotalContract() >= 1250) {
				...
				sendNPCDialogue(14386, 9827, "You need to complete 1'250 contracts to use this title.");
				stage = 1;
				break;
			}
		}
		if (componentId == OPTION_3) {
			if (player.getTotalKills() >= 5000) {
				...
				sendNPCDialogue(14386, 9827, "You need to complete 5'000 contract kills to use this title.");
				stage = 1;
				break;
			}
		}
		if (componentId == OPTION_4) {
			if (player.getTotalKills() >= 15000) {
				...
				sendNPCDialogue(14386, 9827, "You need to complete 15'000 contract kills to use this title.");
				stage = 1;
				break;
			}
		}
