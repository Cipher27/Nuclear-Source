	...
	public void run(int interfaceId, int componentId) {
		if (stage == -1) {
			...
			sendNPCDialogue(
					npcId,
					9827,
					"I need you to go around Hellion and fill out this BarCrawl card for my brother over at the agility course. It shouldn't take too long.");
			stage = 4;
		} else if (stage == 4) {
			...
			player.getInventory().addItem(455, 1);
				sendNPCDialogue(
						npcId,
						9827,
						"Alright! I need you to go to various bars around Hellion and drink their signature Ale. Then fill out the card. Once the card is filled out, come back to me and I will teach you some new skills!");
					...
					stage = -1;
						...
						if (componentId == OPTION_1) {
							sendNPCDialogue(
									npcId,
									9827,
									"You have to go to Pubs around Hellion and fill out the BarCrawl Card by drinking the beer that they give you. Once you have completed that, come back to me.");
							stage = 8;
						} else if (componentId == OPTION_2) {
							...
							sendNPCDialogue(
									npcId,
									9827,
									"The bars are located all around Hellion! But if I told you the exact locations, it wouldn't be as fun!");
