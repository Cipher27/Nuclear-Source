...
public class StarSprite extends Dialogue {
        ...
        public void run(int interfaceId, int componentId) {
                if (stage == -1) {
                	...
                	sendNPCDialogue(npcId, 9827, "You can have whatever is in my pocket... but I want your stardust in return.");
                	stage = 4;
                } else if (stage == 4) { 
                	sendOptions("Select an option", "Small fallen star (120)", "Starfury cosmetic set (1500)","Starfury Sword (1000)","Starfury Bow (1000)", "Starfury Staff (1000)");
                	stage = 5;
                } else if (stage == 5) { 	
