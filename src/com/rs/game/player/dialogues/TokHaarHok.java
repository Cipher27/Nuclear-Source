		...
		case 6:
			...
			case 0:
				...
				sendOptionsDialogue("Choose your reward:",
						"The TokHaar-Kal", "The TokHaar-Kal-Xil", "The TokHaar-Kal-Mej", "An uncut onyx");
			break;
			case 1:
				if (componentId == OPTION_1) {
					stage = 6;
					WorldConstants.addTokCape();
					...
					player.sendMessage("The TokHaar-Kal was added to your bank.");
				}
				if (componentId == OPTION_2) {
					stage = 6;
					WorldConstants.addTokCape();
					player.getBank().addItem(31610, 1, true);
					sendNPCDialogue(npcId, 9827, "The TokHaar-Kal-Xil is a powerful cape that will let others see that you have mastered the Fight Kiln. In addition to this, it provides several stat boosts including 8+ Range." );
					player.sendMessage("The TokHaar-Kal-Xil was added to your bank.");
				}
				if (componentId == OPTION_3) {
					stage = 6;
					WorldConstants.addTokCape();
					player.getBank().addItem(31611, 1, true);
					sendNPCDialogue(npcId, 9827, "The The TokHaar-Kal-Mej is a powerful cape that will let others see that you have mastered the Fight Kiln. In addition to this, it provides several stat boosts including 8+ Magic." );
					player.sendMessage("The TokHaar-Kal-Mej was added to your bank.");
				}
				if (componentId == OPTION_4) {
					stage = 6;
					player.getBank().addItem(6571, 1, true);
					...
					player.sendMessage("The Onyx was added to your bank.");
				}
			break;
			case 2:
			case 3:
