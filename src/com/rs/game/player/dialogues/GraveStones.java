...
public class GraveStones extends Dialogue {
	...
	if (stage == -1) {
	    stage = 0;
	    sendOptionsDialogue("Chose an option", "Can I have a different gravestone?", "Can you restore my prayer?", "Nothing, nevermind.");
	} else if (stage == 0) {
