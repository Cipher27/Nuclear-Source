...
public class BarbarianFishing extends Action {
	...
	public enum Fish {
		...
		SHARK(383, 76, 110, 11, 6705), SWORDFISH(371, 50, 100, 10, 6707), TUNA(359, 35, 80, 8, 6711);
	...
	public enum CatchSpots {
		...
		SWORDFISH_SPOT(312, 2, Fish.TUNA, Fish.SWORDFISH), SHARK_SPOT(313, 2, Fish.SHARK);
	...
	public BarbarianFishing(CatchSpots spot, NPC npc) {
		this.spot = spot;
		this.npc = npc;
