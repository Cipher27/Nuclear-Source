...
public class Enchanting {
    ...
    public enum Types {
        ...
        DRAGONSTONE(5, 68, 2572, 11105, 1712, 11188),
    ...
    public static boolean enchant(Player player, int reqLevel, int toEnchant, int toMake, int enchantLevel) {
		...
		/**
		  * New rs3 enchanting emotes
		  **/
        if(toMake == 6585){ //furry
			player.setNextAnimation(new Animation(24315));
            player.setNextGraphics(new Graphics(5059, 0, 100));
		} else  if(toMake == 1712){ //glory
           player.setNextAnimation(new Animation(24314));
            player.setNextGraphics(new Graphics(5058, 0, 100));
		}else  if(toMake == 1731){ //diamon
           player.setNextAnimation(new Animation(24313));
            player.setNextGraphics(new Graphics(5057, 0, 100));
		}else  if(toMake == 1725){ //ruby
           player.setNextAnimation(new Animation(24312));
            player.setNextGraphics(new Graphics(5056, 0, 100));
		}else  if(toMake == 1729){ //emeral
           player.setNextAnimation(new Animation(24311));
            player.setNextGraphics(new Graphics(5055, 0, 100));
		}else  if(toMake == 1727){ //sapphire
           player.setNextAnimation(new Animation(24310));
            player.setNextGraphics(new Graphics(5054, 0, 100));
		}
		/**
		  * old outdated emotes lol
		  **/
