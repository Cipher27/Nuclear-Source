 ...
 *
 */
public class GrifolicCrafting {

	public static final int FLAKES = 22450;
	...
	public enum GanoItem{
		VISOR(22470,22452,400,65,400),
		PONCHO(22478,22456,3500,78,350),
		LEGS(22474,22454,1200,72,120);
