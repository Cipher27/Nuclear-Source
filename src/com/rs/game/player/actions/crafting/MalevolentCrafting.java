...
/**
 * Handles Malevolent energy SMITHING into Malevolent armour.
 // * @author Paolo.
 */
public class MalevolentCrafting extends Action {
	...
	public enum Malevolent {
		...
		MALEVOLENT_HELM(91, 500, new Item[] { new Item(30027, 14)}, new Item(30005)),
		MALEVOLENT_CUIRASS(93, 1500, new Item[] {new Item(30027, 42)}, new Item(30008)),
		MALEVOLENT_GREAVES(92, 1000, new Item[] {new Item(30027, 28)}, new Item(30011));
