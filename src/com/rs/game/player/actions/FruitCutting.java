...
public class FruitCutting extends Action {
	...
	public enum CuttableFruit {
		BANANA(1963, 3162), RED_BANANA(7572, 7574), LEMON(2102, 2104, 2106), ORANGE(
				2108, 2110, 2112), PINEAPPLE(2114, 2116, 2118), LIME(2120,
				2122, 2124), WATERMELON(5982, 5984);
	...
	public int processWithDelay(Player player) {
		if (player.getInventory().containsItem(fruit.getFruitId(), 1)) {
			...
			player.sm("You have run out of fruit to cut.");
			return -1;
		}
		return 1;
	}
