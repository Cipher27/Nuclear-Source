...
public enum PickPocketableNPC {
	 ...
	 */
	MAN(new short[] { 1, 2, 3, 4, 5, 6, 16, 24, 170, 7875, 7883, 7882, 7876, 7879, 7873, 7878 }, new byte[] { 1, 11, 21,
			31 }, new byte[] { 1, 1, 11, 21 }, 8.0, 4, 10, new Item(995, 300)),

	/**
	 * The regular farmer npcs.
	 */
	 FARMER(new short[] { 7, 1757, 1758, 1760 }, new byte[] { 10, 20, 30, 40 },
			new byte[] { 1, 10, 20, 30 }, 14.5, 4, 10, new Item(995, 500),
			new Item(5318, 1)),
	/**
	...
	WARRIOR(new short[] { 15, 18 }, new byte[] { 25, 35, 45, 55 }, new byte[] {
			1, 25, 35, 45 }, 26, 5, 20, new Item(995, 180)),
	 ...
	 */
	MASTER_FARMER(new short[] { 2234, 2235, 8512 }, new byte[] { 38, 48, 58, 68 },
	...
	GUARD(new short[] { 9, 32, 206, 296, 297, 298, 299, 344, 345, 346, 368,
			678, 812,5919,5920 }, new byte[] { 40, 50, 60, 70 }, new byte[] { 1, 40, 50,
			60 }, 46.5, 4, 20, new Item(995, 3500)),

	/**
	 * Fremennik citizen. TODO: correct npc ids.
	 */
	FREMENNIK_CITIZEN(new short[] { 2462 }, new byte[] { 45, 55, 65, 75 },
			new byte[] { 1, 45, 55, 65 }, 65, 4, 20, new Item(995, 400)),

	/**
	 * A knight of ardougne.
	 */
	ARDOUGNE_KNIGHT(new short[] { 23, 26 }, new byte[] { 55, 65, 75, 85 },
			new byte[] { 1, 55, 65, 75 }, 84.3, 4, 30, new Item(995, 1200)),
	...
	PALADIN(new short[] { 20, 2256 }, new byte[] { 70, 80, 90, 100 },
			new byte[] { 1, 70, 80, 90 }, 151.75, 4, 30, new Item(995, 1200),
			new Item(562, 2)),
	...
	HERO(new short[] { 21 }, new byte[] { 80, 90, 100, 110 }, new byte[] { 1,
			80, 90, 100 }, 275, 5, 40, new Item(995, 2000), new Item(995, 3000),
	...
	DWARF_TRADER(new short[] { 2109, 2110, 2111, 2112, 2113, 2114, 2115, 2116,
			...
			420, 6, 10, new Item(995, 100), new Item(995, 400),
