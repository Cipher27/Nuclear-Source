...
public class ChargeWaterOrb extends Action {
    ...
    public int processWithDelay(Player player) {
    	if (checkAll(player)) {
		    ...
		    Magic.checkSpellRequirements(player, 56, true, 555, 30, 564, 3);
		    player.getSkills().addXp(Skills.MAGIC, 66);
			player.setNextAnimation(new Animation(24468));
			player.setNextGraphics(new Graphics(5098));
			player.sendMessage("You fill the orb with the power of Water.");
			player.getInventory().addItem(571, 1);
		}
		return 0;
    }
