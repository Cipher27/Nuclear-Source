...
public class TheLooterAchievement extends Achievement {
	/**
	 * 
	 */
	private static final long serialVersionUID = 7468456336012909571L;

	public TheLooterAchievement() {
		super(Types.MEDIUM, "The Looter I","Loot a total of @TOTAL@ barrow chests.");
	}
