...
/*	private void teletoDoor(Player player, int id) {
	...
	public void sendFirstScene() {
		...
		final NPC nomad = World.spawnNPC(8531, new WorldTile(getBaseX() + 41, getBaseY() + 11, 0), -1, true, true, false);
		nomad.setRun(true);
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				if (stage == 1) {
					...
					Nomad nomad =(Nomad) World.spawnNPC(8528, throne, -1, true, true, false);
