...
public class FightKiln extends Controler {
	...
	public static void enterFightKiln(Player player, boolean quickEnter) {
		if(player.isDonator())
			player.getControlerManager().startControler("FightKilnControler", 11);
		else
		...
		if(type == 0) {
			...
			if(type == 1 || type == 4) {
				...
				if(type == 4) {
					...
					if(HallOfFame.firstFightKiln[0] == null){
	...
	public void process() {
	 ...
	 @Override
		public boolean processMagicTeleport(WorldTile toTile) {
			player.getDialogueManager().startDialogue("SimpleMessage", "You cannot teleport out of the fight kiln!");
			return false;
		}
