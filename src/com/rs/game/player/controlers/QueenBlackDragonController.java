...
public final class QueenBlackDragonController extends Controler {
	...
	public static final WorldTile OUTSIDE = new WorldTile(1199, 6499, 0);
	...
	public boolean processObjectClick1(WorldObject object) {
		...
		if (object.getId() == 70813) {
			...
			if (player.isPker)
				...
				i = 0;
			Magic.sendObjectTeleportSpell(player, true, Settings.RESPAWN_PLAYER_LOCATION[i]);
			return false;
		}
	...
	private void end(int type) {
		...
		if (type == 0) {
			player.getInterfaceManager().sendInterfaces();
			player.getPackets().sendGlobalConfig(184, -1);
			player.setNextWorldTile(new WorldTile(2327,3679,0));
		} else {
