...
public class CosmeticOverrides implements Serializable {
	...
	public void setOutfit(CosmeticItems outfit) {
		//player.getAppearence().resetCosmetics();
		//player.getAppearence().loadAppearanceBlock();
		player.getAppearence().setCosmetic((outfit.getHelmId() == 0 || showHelm) ? null : new Item(outfit.getHelmId()), Equipment.SLOT_HAT);
		player.getAppearence().setCosmetic((outfit.getChestId() == 0 || showBody) ? null : new Item(outfit.getChestId()), Equipment.SLOT_CHEST);
		player.getAppearence().setCosmetic((outfit.getLegsId() == 0 || showLegs) ? null : new Item(outfit.getLegsId()), Equipment.SLOT_LEGS);
		player.getAppearence().setCosmetic((outfit.getBootsId() == 0 || showBoots) ? null : new Item(outfit.getBootsId()), Equipment.SLOT_FEET);
		player.getAppearence().setCosmetic((outfit.getGlovesId() == 0 || showGloves) ? null : new Item(outfit.getGlovesId()), Equipment.SLOT_HANDS);
		player.getAppearence().setCosmetic((outfit.getCapeId() == 0 || showCape) ? null : new Item(outfit.getCapeId()), Equipment.SLOT_CAPE);
...
//		/player.getAppearence().loadAppearanceBlock();
	...
	//	player.getAppearence().cosmeticItems[slot] = item;
	}
	...
	//	player.getAppearence().cosmeticItems = new Item[14];
		this.outfit = null;
		player.getAppearence().generateAppearenceData();
		if (Settings.DEBUG)
