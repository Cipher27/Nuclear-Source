...
import com.rs.net.encoders.RobotGamePacketEncoder;
import com.rs.net.encoders.WorldPacketsEncoder;
import com.rs.utils.IPBanL;

public class Session {
	
	private final PacketTransmitter TRANSMITTER = new PacketTransmitter(this);

	public void setRobotPackets(Player player) {
		TRANSMITTER.setPackets(new RobotGamePacketEncoder(player));
	}
	 ...
	 */
	public PacketTransmitter getTransmitter() {
		return TRANSMITTER;
	}
}
