...
public class RobotGamePacketEncoder extends WorldPacketsEncoder {

	private Player player;

	public RobotGamePacketEncoder(Player player) {
		super(null,player);
	}
	...
	@Override
	public com.rs.io.OutputStream createWorldTileStream(WorldTile tile) {
		return null;
	}
