...
public class Class4 {
	...
	public static void method68(Class5 class5) {
		...
		while (flag20) {
			...
			if (byte0 != 0)
				class5.blockRandomized = true;
			else
				class5.blockRandomized = false;
			if (class5.blockRandomized)
			...
			for (int l3 = 0; l3 < j4; l3++) {
				...
				method72(class5.anIntArrayArray88[l3], class5.anIntArrayArray89[l3], class5.anIntArrayArray90[l3],
						class5.aByteArrayArray87[l3], byte8, i, i4);
			...
			for (int k5 = ai2[l7 - ai1[i7]]; k5 != l4;)
				if (k5 == 0 || k5 == 1) {
					...
					if (j11 < 16) {
						...
						for (; l10 > 0; l10--) {
							class5.anIntArray84[l10]--;
							class5.aByteArray83[class5.anIntArray84[l10]] = class5.aByteArray83[(class5.anIntArray84[l10
									- 1] + 16) - 1];
						}
	...
	public static void method69(Class5 class5) {
		...
		byte abyte0[] = class5.destination;
		int i1 = class5.anInt60;
		int j1 = class5.destinationLength;
		int k1 = j1;
		...
		class5.anInt72 = l;
		class5.destination = abyte0;
		class5.anInt60 = i1;
		class5.destinationLength = j1;
	}
	...
	public static int unpack(byte destination[], int destLen, byte source[], int srcLen, int startPos) {
		synchronized (packerResult) {
			packerResult.source = source;
			packerResult.startPos = startPos;
			packerResult.destination = destination;
			packerResult.sourceLen = srcLen;
			packerResult.destinationLength = destLen;
			packerResult.anInt57 = 0;
			packerResult.anInt58 = 0;
			packerResult.anInt60 = 0;
			packerResult.anInt62 = 0;
			packerResult.anInt63 = 0;
			packerResult.anInt67 = 0;
			packerResult.anInt68 = 0;
			packerResult.anInt70 = 0;
			method68(packerResult);
			destLen -= packerResult.destinationLength;
			int l = destLen;
			return l;
		}
	}
	...
	public static int method74(int i, Class5 class5) {
		...
		do {
			...
			class5.anInt67 = class5.anInt67 << 8 | class5.source[class5.startPos] & 0xff;
			class5.anInt68 += 8;
			class5.startPos++;
			class5.sourceLen--;
			class5.anInt57++;
	...
	public static Class5 packerResult = new Class5();
